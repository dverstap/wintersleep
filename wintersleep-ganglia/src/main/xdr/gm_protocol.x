const __GANGLIA_MTU  =   1500;
const __UDP_HEADER_SIZE = 28;
const __MAX_TITLE_LEN = 32;
const __MAX_GROUPS_LEN = 128;
const __MAX_DESC_LEN = 128;
/*
const UDP_HEADER_SIZE = __UDP_HEADER_SIZE
const MAX_DESC_LEN = __MAX_DESC_LEN
const GM_PROTOCOL_GUARD
const GANGLIA_MAX_XDR_MESSAGE_LEN (__GANGLIA_MTU - __UDP_HEADER_SIZE - 8)
*/
